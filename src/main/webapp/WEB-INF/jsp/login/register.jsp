...
<script type="text/javascript">
	function checkForm() {
		...
		if (document.newMember.passwd.value != document.newMember.passwd_confirm.value) {
...
<body>
	...
	<div class="container">
		<form name="newMember" class="form-horizontal"  action="/registerPost" method="post" onsubmit="return checkForm()">
